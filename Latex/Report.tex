...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \multirow{3}{*}{Gold price} & Top 1 & GRU (9) & GRU (9) & LSTM (9) & GRU \\ \cline{2-6} 
                                  & Top 2 & RNN (6) & RNN (6) & GRU (6) & RNN \\ \cline{2-6} 
                                  & Top 3 & LSTM (3) & LSTM (3) & RNN (3) & LSTM (top 2) \\ \hline
        \multirow{3}{*}{Platium price} & Top 1 & LSTM (8) & GRU (9) & GRU (8) & GRU \\ \cline{2-6} 
                                      & Top 2 & GRU (7) & LSTM (6) & LSTM (7) & LSTM \\ \cline{2-6} 
                                      & Top 3 & RNN (3) & RNN (3) & RNN (3) & RNN \\ \hline
        \multirow{3}{*}{Silver price} & Top 1 & GRU (9) & GRU (9) & GRU (9) & GRU \\ \cline{2-6} 
